...
import { callAIText } from '../../../backend/intelligence/models/index.js';
import {
    detectProviderProxy,
    listProviderModels,
...
router.post('/list-models', async (req, res) => {
    try {
        res.json(await listProviderModels(req.body));
    } catch (err) {
...
router.post('/test-connection', async (req, res) => {
    try {
        res.json(await testProviderConnection(req.body));
    } catch (err) {
...
router.post('/detect-network-proxy', async (_req, res) => {
    try {
        res.json(await detectProviderProxy());
    } catch (err) {
        res.json({ success: false, error: err.message });
    }
});
